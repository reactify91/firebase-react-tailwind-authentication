            ...
            <div className=" flex flex-col items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border p-6 shadow-2xl">
                ...
                <div className="w-full flex flex-col gap-3">
                    <div className="w-full h-14 border border-[3px] relative rounded-lg transition-all duration-500 ease-in-out  flex items-center px-1 gap-2 focus-within:border-red-600 group">
                        ...
                        <input type="email" name="email"  className="block w-full h-full p-1 outline-none indent-1 group" onChange={(e)=>setEmail(e.target.value)}/>
                    </div>
                    <div className="w-full h-14 border border-[3px] relative rounded-lg transition-all duration-500 ease-in-out  flex items-center px-1 gap-2 focus-within:border-red-600 group">
                        ...
                        <input type="password" name="password" className="block w-full h-full p-1 outline-none indent-1 group" onChange={(e)=>setPassword(e.target.value)}/>
                    </div>
                    ...
                    <div className="flex justify-center items-center  gap-3 bg-red-600/90 text-white hover:bg-red-600 rounded-xl w-full cursor-pointer p-3 " onClick={handleLogin}>
                        <FiUser />
                        Giriş
                    </div>
                    <div className="text-center">Üyeliğin yok mu? <span className="text-red-600 cursor-pointer underline"><Link to="/register">Kayıt ol</Link></span></div>
                </div>
